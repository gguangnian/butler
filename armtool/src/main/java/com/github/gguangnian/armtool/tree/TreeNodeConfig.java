 ...
 * //使用自定义配置项
 * TreeNodeConfig customConfig = new TreeNodeConfig();
 * customConfig.setIdKey("XXX")
 * ...
 * // {@link #weightKey} 属性是非常必要的属性
 * customConfig.setWeightKey("XXX");
 * </pre>
 *
 * @author gcz
 * @Date 2022/6/23
...
public class TreeNodeConfig implements Serializable {
     ...
     * @return this
     */
    public TreeNodeConfig setDeep(int deep) {
        this.deep = deep;
        return this;
    }
}
